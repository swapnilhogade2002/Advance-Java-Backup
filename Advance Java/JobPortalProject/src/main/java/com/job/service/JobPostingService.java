...
//	view jobs to company
	public Page<JobPosting> getJobsByUserP(Long userId, Pageable pageable) {
		return jobPostingRepository.findByUserId(userId,pageable);
	}
...
//	count of category
	public Long countJobPostingsInHumanResourceCategory() {
		return jobPostingRepository.countByJobCategoryHumanResource();
	}

	public Long countByJobCategoryBussinessDevelopment() {
		return jobPostingRepository.countByJobCategoryBussinessDevelopment();
	}

	public Long countByJobCategoryCustomeService() {
		return jobPostingRepository.countByJobCategoryCustomeService();
	}

	public Long countByJobCategoryDesignAndCreative() {
		return jobPostingRepository.countByJobCategoryDesignAndCreative();
	}

	public Long countByJobCategoryMarketing() {
		return jobPostingRepository.countByJobCategoryMarketing();
	}

	public Long countByJobCategoryProjectManagement() {
		return jobPostingRepository.countByJobCategoryProjectManagement();
	}

	public Long countByJobCategorySalesAndCommunication() {
		return jobPostingRepository.countByJobCategorySalesAndCommunication();
	}

	public Long countByJobCategoryTeachingAndEducation() {
		return jobPostingRepository.countByJobCategoryTeachingAndEducation();
	}
